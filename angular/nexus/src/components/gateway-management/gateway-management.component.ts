    ...
    <div class="h-full flex flex-col bg-[rgb(var(--color-surface))]">
      <div class="p-6 border-b border-[rgb(var(--color-border-base))] bg-[rgb(var(--color-surface-muted))]">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-xl font-bold text-[rgb(var(--color-text-prominent))]">Gateways</h1>
            <p class="text-sm text-[rgb(var(--color-text-muted))]">Manage your broker gateway profiles</p>
          </div>
          <button
            (click)="addGateway.emit()"
